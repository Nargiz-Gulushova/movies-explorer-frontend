    ...
    <section id='about' className='about-project'>
      ...
      <ul className='about-project__info'>
        <li className='about-project__box'>
          ...
          <p className='about-project__box-caption'>Составление плана, работу над бэкендом, вёрстку, добавление функциональности и финальные доработки.</p>
        </li>
        <li className='about-project__box'>
          <h3 className='about-project__box-heading'>На выполнение диплома ушло 5 недель</h3>
          <p className='about-project__box-caption'>У каждого этапа был мягкий и жёсткий дедлайн, которые нужно было соблюдать, чтобы успешно защититься.</p>
        </li>
      </ul>
